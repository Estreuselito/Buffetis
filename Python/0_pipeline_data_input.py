...
stocks = wrds_conn.get_table(library='crsp', 
                              table='msf', 
                              columns=['permno', 'cusip', 'date', 'prc', 'vol', 'ret', 'shrout'],
                              obs=5)
...
fundamentals_a.to_sql("fundamentals_a", connection, if_exists="replace", index=False)
...
fundamentals_q.to_sql("fundamentals_q", connection, if_exists="replace", index=False)
